...
void DMainWindow::OnShowLogMan(bool should_show)
{
	if (should_show)
	{
...
void DMainWindow::OnShowLogSettings(bool should_show)
{
	if (should_show)
	{
...
void DMainWindow::OnShowToolbar(bool should_show)
{
	toolBar->setVisible(should_show);
}
