...
static const char *TEVCMPColorOPTable[16] =
{
	...
	"   (%s&0xFF) + ((idot((%s.rgb&0xFF), comp16) >  idot((%s.rgb&0xFF), comp16)) ? (%s&0xFF): int3(0,0,0))",//#define TEVCMP_GR16_GT 10
	"   (%s&0xFF) + ((idot((%s.rgb&0xFF), comp16) == idot((%s.rgb&0xFF), comp16)) ? (%s&0xFF): int3(0,0,0))",//#define TEVCMP_GR16_EQ 11
	"   (%s&0xFF) + ((idot((%s.rgb&0xFF), comp24) >  idot((%s.rgb&0xFF), comp24)) ? (%s&0xFF): int3(0,0,0))",//#define TEVCMP_BGR24_GT 12
	"   (%s&0xFF) + ((idot((%s.rgb&0xFF), comp24) == idot((%s.rgb&0xFF), comp24)) ? (%s&0xFF): int3(0,0,0))",//#define TEVCMP_BGR24_EQ 13
...
static const char *TEVCMPAlphaOPTable[16] =
{
	...
	"   (%s.a&0xFF) + ((idot((%s.rgb&0xFF), comp16) >  idot((%s.rgb&0xFF), comp16)) ? (%s.a&0xFF) : 0)",//#define TEVCMP_GR16_GT 10
	"   (%s.a&0xFF) + ((idot((%s.rgb&0xFF), comp16) == idot((%s.rgb&0xFF), comp16)) ? (%s.a&0xFF) : 0)",//#define TEVCMP_GR16_EQ 11
	"   (%s.a&0xFF) + ((idot((%s.rgb&0xFF), comp24) >  idot((%s.rgb&0xFF), comp24)) ? (%s.a&0xFF) : 0)",//#define TEVCMP_BGR24_GT 12
	"   (%s.a&0xFF) + ((idot((%s.rgb&0xFF), comp24) == idot((%s.rgb&0xFF), comp24)) ? (%s.a&0xFF) : 0)",//#define TEVCMP_BGR24_EQ 13
